...
class Canevas(tk.Canvas):
    ...
    def __init__(self, master, largeur, hauteur):
        tk.Canvas.__init__(self, master, width=largeur, height=hauteur, bg="black", confine=True, highlightthickness=0,
                           borderwidth=0)
        # attributs
    ...
    def dessinerRectangle(self, x, y, l, h, col):
        return ObjetGraphique(self.master, self.create_rectangle(x, y, x + l, y + h, fill=col, width=1, outline=col), x,
                              y, col)
    ...
    def dessinerCercle(self, x, y, r, col):
        return ObjetGraphique(self.master, self.create_oval(x - r, y - r, x + r, y + r, width=1, outline=col), x, y,
                              col)
